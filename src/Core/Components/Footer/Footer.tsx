  ...
  const socialMedias = [
    {
      ...
      alt: 'github',
      path: `M24 4.557c-.883.392-1.832.656-2.828.7751.017-.609
      ...
      1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179
      1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695
      1.797-1.562 2.457-2.549z`,
    },
    {
      href: 'https://github.com/',
      alt: 'vk',
      path: `M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356
    ...
    },
    {
      href: 'https://github.com/',
      alt: 'telegram',
      path: `M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333
  ...
  return (
    <footer
      ...
      <div className="flex items-center">
        ...
        <button onClick={toolsHandler} type="button" className="text-white">
